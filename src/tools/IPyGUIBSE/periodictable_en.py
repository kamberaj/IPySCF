...
def load_json(filename: str = 'src/tools/IPyGUIBSE/elements_en.json') -> Iterator[Element]:
...
class ElementButton:
    ...
    CATEGORY_COLORS = {
        'AlkaliMetals': '#fe6f61',
        'ErdalkaliMetals': '#6791a7',
        'Superconductors': '#83b8d0',
        'Metals': '#cae2ed',
        'SemiMetals': '#a7d6bc',
        'NonMetals': '#ffde66',
        'Halogene': '#e9aa63',
